// Icons used in the Dua Management app
...
export function NoAudioIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function CheckboxIcon({ checked, small }: { checked: boolean; small?: boolean }) {
